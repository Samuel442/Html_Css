...
app.get("/pagina_manutencao", function(req,res){  // cria rota drone
    res.render("manutencao");                       // renderiza o aquivo html index.ejs (deve estar na pasta views)
});


app.get("/nrs", function(req,res){  // cria rota drone
    res.render("nrs");                       // renderiza o aquivo html index.ejs (deve estar na pasta views)
});
